...
table1::table1( ~ AE+Adhere+age+race+gender+bviral0+bviral1+bviral2+bviral3+
                  bviral4+bviral5+sviral0+sviral1+sviral2+sviral3+
                  sviral4+sviral5| treatment, data = alldata%>%dplyr::select(-ptid))
```
